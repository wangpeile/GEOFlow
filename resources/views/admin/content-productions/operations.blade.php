...
<div class="space-y-6">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">统计均可下钻到文章工作单与文章，时间口径为 {{ $metrics['period']['timezone'] }}。</p>
        </div>
    ...
    <div class="grid gap-4 md:grid-cols-4">
        @foreach ([
            ['文章工作单', $metrics['productions']['total']],
    ...
    <div class="overflow-hidden rounded-lg bg-white shadow ring-1 ring-gray-200">
        <div class="border-b border-gray-200 px-5 py-4 font-semibold text-gray-900">最近文章工作单</div>
        <div class="overflow-x-auto"><table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-gray-50"><tr><th class="px-5 py-3 text-left">工作单</th><th class="px-5 py-3 text-left">主题</th><th class="px-5 py-3 text-left">状态</th><th class="px-5 py-3 text-left">时间</th></tr></thead>
