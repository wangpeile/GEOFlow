...
return [
    ...
    // 定制内容生产工作台总开关；关闭时不显示入口，也不会执行生产计划。
    'content_production_pipeline_enabled' => filter_var(env('GEOFLOW_CONTENT_PRODUCTION_PIPELINE_ENABLED', false), FILTER_VALIDATE_BOOLEAN),
