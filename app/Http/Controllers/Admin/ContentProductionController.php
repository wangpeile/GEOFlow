...
class ContentProductionController extends Controller
{
    ...
    public function show(Request $request, ContentProduction $contentProduction): View
    {
        ...
        $contentProduction->load([
            ...
            'articleRevisionRequests.createdBy:id,username,display_name',
            'articleRevisionRequests.sourceArticleVersion:id,content_production_id,version,title',
            'articleRevisionRequests.revisedArticleVersion:id,content_production_id,version,title',
            'articleRevisionRequests.qualityReport:id,content_production_id,article_version_id,status',
