...
final class ArticleEditorAssistantController extends Controller
{
    ...
    /**
     * Keep the production-workbench editor assistant endpoint compatible with
     * the v3 editor assistant controller. The v3 endpoints below serve the
     * standard article editor; this action serves an existing article draft.
     */
